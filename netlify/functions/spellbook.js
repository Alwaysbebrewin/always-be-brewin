...
// The frontend now sends properly formed Scryfall-style `card:"..."`
// queries (one clause per filled card box), so we pass those through
// untouched. Plain text (any other caller) still gets wrapped as a
